...
.. |edx_django_utils.plugins.plugin_manager| replace:: ``edx_django_utils.plugins.plugin_manager``
.. _edx_django_utils.plugins.plugin_manager: https://github.com/edx/edx-platform/blob/master/openedx/core/lib/plugins.py
